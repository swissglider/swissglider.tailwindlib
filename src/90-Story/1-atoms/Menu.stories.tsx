...
export default {
    title: 'Internal/1-Atoms/Menu',
    argTypes: {
        mode: {
            name: 'Mode: Default Dark',
            options: Object.keys(TailwindLib.Lists.MenuModeMap),
            control: { type: 'select' },
        },
...
} as ComponentMeta<typeof TailwindLib.Components.Menu>;
...
const MenuTemplate: ComponentStory<typeof TailwindLib.Components.Menu> = ({
    mainMenuListVisible,
    mode,
    searchFunc,
}) => {
...
export const Menu1 = MenuTemplate.bind({});
Menu1.args = {
    mainMenuListVisible: true,
    mode: 'dark',
};
